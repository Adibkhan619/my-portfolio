        ...
        <div className="lg:space-y-16 space-y-4 lg:mt-24 mt-10">
            ...
            data-aos="fade-up">
                <div className="lg:grid gap-5 lg:grid-cols-2 flex flex-col">
                    ...
                    <img className="lg:w-72 border rounded-xl shadow-lg hidden lg:flex"src={img4} alt="Album" />
                </div>
            ...
            <div className="card p-4 lg:p-8  justify-center gap-10 lg:card-side bg-green-50 bg-opacity-70 shadow-xl"  data-aos="fade-up">
                <div className="lg:grid gap-5 lg:grid-cols-2 flex flex-col">
                    ...
                    <img className="lg:w-72 border rounded-xl shadow-lg hidden lg:flex"src={img8} alt="Album" />
                </div>
                <div className="card-body lg:w-1/2">
            ...
            <div className="card p-4 lg:p-8  justify-center gap-10 lg:card-side bg-red-50 bg-opacity-70 shadow-xl"  data-aos="fade-up">
                <div className="lg:grid gap-5 lg:grid-cols-2 flex flex-col">
                    ...
                    <img className="lg:w-72 border rounded-xl shadow-lg hidden lg:flex" src={img11} alt="Album" />
