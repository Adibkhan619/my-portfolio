    ...
    return (
        <div className="space-y-16 lg:mt-24">
            ...
            <div className="card p-8  justify-center gap-10 lg:card-side bg-base-200 shadow-xl">
                ...
                <div className="card-body w-1/2">
                    <h2 className="card-title text-3xl">Flavor Paradise (Restaurant Management Website)</h2>
                    <p>
                    ...
                    <div className="card-actions justify-end">
                        <Link to="https://restaurant-management-we-b1988.web.app/"><button className="btn bg-sky-300 shadow-sm">Go to webpage</button></Link>
            ...
            <div className="card p-8  justify-center gap-10 lg:card-side bg-base-200 shadow-xl">
                ...
                <div className="card-body w-1/2">
                    <h2 className="card-title text-3xl">Wonder Seeker (Tourism Management Website)</h2>
                    <p>
